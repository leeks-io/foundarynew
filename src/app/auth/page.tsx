                        ...
                        >
                            ...
                            <div className="space-y-4">
                                ...
                                <button
                                    ...
                                    disabled={loading}
                                    className="w-full bg-[#24292e] text-white font-bold h-11 rounded-lg flex items-center justify-center gap-2 hover:bg-[#2c3238] transition-colors disabled:opacity-50"
                                >
                                ...
                                <button
                                    className="w-full bg-black border border-[#1a1a1a] text-white font-bold h-11 rounded-lg flex items-center justify-center gap-2 hover:bg-white/5 transition-colors"
                                >
